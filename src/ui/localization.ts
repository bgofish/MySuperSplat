        ...
        resources: {
            de: {
                translation: {
                    ...
                    'options.outlier-color': 'Ausreißer Farbe',
                    ...
                    'options.depth-auto-range': 'Automatischer Bereich',
                    'options.depth-reverse': 'Tiefe umkehren',
                    'options.depth-color-ramp': 'Farbschema',
                    'options.depth-color-ramp.grayscale': 'Graustufen',
                    'options.depth-color-ramp.viridis': 'Viridis',
                    'options.depth-color-ramp.plasma': 'Plasma',
                    'options.depth-color-ramp.inferno': 'Inferno',
                    'options.depth-color-ramp.turbo': 'Turbo',
                    'options.depth-color-ramp.jet': 'Jet',
                    'options.depth-color-ramp.custom': 'Benutzerdefiniert...',
                    'options.depth-y-mode': 'Y-Tiefe Modus',
                    'options.depth-blend': 'Tiefe Mischung',
                    ...
                    'shortcuts.area-measurement': 'Flächenmessung',
                    'shortcuts.camera-information': 'Kamera Information',
                    'shortcuts.distance-measurement': '2 Punkte Distanzmessung',
                    'shortcuts.splat-size-display': 'Splat Größenanzeige',
                    ...
                    'shortcuts.unlock-all-splats': 'Alle Splat-Ebenen freigeben',
            ...
            en: {
                translation: {
                    ...
                    'options.depth-auto-range': 'Auto Range',
                    'options.depth-reverse': 'Reverse Depth',
                    'options.depth-color-ramp': 'Color Scheme',
                    'options.depth-color-ramp.grayscale': 'Grayscale',
                    'options.depth-color-ramp.viridis': 'Viridis',
                    'options.depth-color-ramp.plasma': 'Plasma',
                    'options.depth-color-ramp.inferno': 'Inferno',
                    'options.depth-color-ramp.turbo': 'Turbo',
                    'options.depth-color-ramp.jet': 'Jet',
                    'options.depth-color-ramp.custom': 'Custom...',
                    'options.depth-y-mode': 'Y Depth Mode',
                    'options.depth-blend': 'Depth Blend',
                    ...
                    'shortcuts.area-measurement': 'Area Measurement',
                    'shortcuts.camera-information': 'Camera Information',
                    'shortcuts.distance-measurement': '2 Points Distance Measurement',
                    'shortcuts.splat-size-display': 'Splat Size Display',
                    ...
                    'shortcuts.unlock-all-splats': 'Unlock All Splat Layers',
                    ...
                    'video.stereo3d': 'Stereoscopic 3D (Top/Bottom)',
                    'video.eyeSeparation': 'Eye Separation (m)',
            ...
            fr: {
                translation: {
                    ...
                    'options.depth-visualization': 'Visualisation de profondeur',
                    'options.depth-min': 'Profondeur Min (Blanc)',
                    'options.depth-max': 'Profondeur Max (Noir)',
                    'options.depth-auto-range': 'Plage Auto',
                    'options.depth-reverse': 'Inverser la profondeur',
                    'options.depth-color-ramp': 'Schéma de couleurs',
                    'options.depth-color-ramp.grayscale': 'Niveaux de gris',
                    'options.depth-color-ramp.viridis': 'Viridis',
                    'options.depth-color-ramp.plasma': 'Plasma',
                    'options.depth-color-ramp.inferno': 'Inferno',
                    'options.depth-color-ramp.turbo': 'Turbo',
                    'options.depth-color-ramp.jet': 'Jet',
                    'options.depth-color-ramp.custom': 'Personnalisé...',
                    'options.depth-y-mode': 'Mode profondeur Y',
                    'options.depth-blend': 'Mélange de profondeur',
                    ...
                    'shortcuts.area-measurement': 'Mesure de surface',
                    'shortcuts.camera-information': 'Informations caméra',
                    'shortcuts.distance-measurement': 'Mesure de distance 2 points',
                    'shortcuts.splat-size-display': 'Affichage taille Splat',
                    'shortcuts.selection': 'SELECTION',
                    ...
                    'shortcuts.unlock-all-splats': 'Déverrouiller toutes les couches de splats',
            ...
            ja: {
                translation: {
                    ...
                    'shortcuts.area-measurement': 'エリア測定',
                    'shortcuts.camera-information': 'カメラ情報',
                    'shortcuts.distance-measurement': '2点間距離測定',
                    'shortcuts.splat-size-display': 'スプラットサイズ表示',
                    ...
                    'shortcuts.unlock-all-splats': '全てのSplatレイヤーのロック解除',
            ...
            ko: {
                translation: {
                    ...
                    'shortcuts.area-measurement': '면적 측정',
                    'shortcuts.camera-information': '카메라 정보',
                    'shortcuts.distance-measurement': '2점 거리 측정',
                    'shortcuts.splat-size-display': 'Splat 크기 표시',
                    ...
                    'shortcuts.unlock-all-splats': '모든 Splat 레이어 잠금 해제',
            ...
            'zh-CN': {
                translation: {
                    ...
                    'shortcuts.area-measurement': '面积测量',
                    'shortcuts.camera-information': '相机信息',
                    'shortcuts.distance-measurement': '两点距离测量',
                    'shortcuts.splat-size-display': 'Splat 大小显示',
                    ...
                    'shortcuts.unlock-all-splats': '解锁全部 Splat 图层',
